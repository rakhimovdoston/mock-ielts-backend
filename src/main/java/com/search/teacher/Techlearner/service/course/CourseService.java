...
import com.search.teacher.Techlearner.dto.course.CourseResponse;
...
import com.search.teacher.Techlearner.repository.CategoryRepository;
import com.search.teacher.Techlearner.repository.CourseRepository;
import com.search.teacher.Techlearner.repository.LessonRepository;
...
public class CourseService {
    ...
    public JResponse getAllCourses(Teacher currentTeacher, CourseFilter filter) {
        int total = courseDbService.totalCourses(currentTeacher, filter);
        List<Course> courses = courseDbService.getAllCourses(currentTeacher, filter);
        if (courses.isEmpty())
    ...
    @Transactional
    public JResponse addCourse(Teacher currentTeacher, CourseDto dto) {
    ...
    @Transactional
    public JResponse updateCourse(Long id, Teacher currentTeacher, CourseDto dto) {
