...
public class FileService {
    ...
    public JResponse uploadAudio(User currentUser, MultipartFile file) {
        ...
        imageRepository.save(image);
        return JResponse.success(new ImageDto(image.getId(), image.getUrl(), image.getOriginalFilename()));
    }
