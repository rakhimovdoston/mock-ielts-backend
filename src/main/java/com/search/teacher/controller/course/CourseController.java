//package com.search.teacher.controller.course;
//
...
//import com.search.teacher.service.course.CourseService;
...
//        filter.setPage(page);
//        filter.setSize(size);
//        return courseService.getAllCourses(securityUtils.currentUser(), filter);
//    }
//
//    @PostMapping("add")
//    public JResponse addCourse(@RequestBody CourseDto course) {
//        return courseService.addCourse(securityUtils.currentUser(), course);
//    }
//
//    @PutMapping("update/{id}")
//    public JResponse updateCourse(@PathVariable Long id, @RequestBody CourseDto course) {
//        return courseService.updateCourse(id, securityUtils.currentUser(), course);
//    }
//
...
//        return courseService.addLessonToCourse(courseId, securityUtils.currentUser(), lesson);
//    }
//
...
//                                        @RequestBody LessonDto lesson) {
//        return courseService.updateLesson(courseId, lessonId, securityUtils.currentUser(), lesson);
//    }
//
...
//        return courseService.deleteLesson(courseId, lessonId, securityUtils.currentUser());
//    }
//}
